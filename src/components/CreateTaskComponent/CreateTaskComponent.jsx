      ...
      {showModal ? (
        <>
          {navigator.onLine ? (
            ...
            <div>
              <div className="justify-end items-center w-1/2 overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                <AlertComponent
                  msg={"No puedes guardar informacion si estas offline"}
                  setShowOnlineAlert={setShowOnlineAlert}
                  showOnlineAlert={showOnlineAlert}
                />
              </div>
            </div>
          )}
